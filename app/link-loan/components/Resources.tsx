...
import image1 from "../../../public/link-loan/link-loan-video.svg"
...
const Resources = () => {
  ...
  <div className="m-2 p-2 gap-4">
    <a
      href="https://www.youtube.com/watch?v=Ufusr5zFl1k"
      target="_blank"
    ...
    >
      <Image
        ...
        width={800}
        height={100}
        alt="What is Link Fixed Rate"
        className="pt-4"
      />
    </a>
  </div>
  <p className="text-gray-600 text-center text-lg pb-2">
    WHAT IS LINK FIXED RATE?
  </p>
</section>
      </>
    )
